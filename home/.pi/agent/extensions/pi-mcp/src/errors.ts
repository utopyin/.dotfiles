...
export class NeedsAuthError extends Error {
    ...
    constructor(serverName: string, transport: StreamableHTTPClientTransport | SSEClientTransport, message?: string) {
 ...
 */
export const wrapError = (error: unknown, context?: McpUiErrorContext): McpUiError => {
