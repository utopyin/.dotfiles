...
-- Use Caps Lock as the dedicated Hyper/Mod3 modifier.
-- Pressing both Shift keys together still toggles Caps Lock.
hl.config({
  input = {
    -- Match macOS "Canadian English" QWERTY (Shift+2 = @).
    kb_layout = "ca",
    kb_variant = "eng",
