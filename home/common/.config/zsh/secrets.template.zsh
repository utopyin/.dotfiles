...
export AXIOM_QUERY_TOKEN="op://Personal/Dotfiles AXIOM_QUERY_TOKEN/password"
export FIRECRAWL_API_KEY="op://Personal/Dotfiles FIRECRAWL_API_KEY/password"
export GRAFANA_SERVICE_ACCOUNT_TOKEN="op://Personal/Dotfiles GRAFANA_SERVICE_ACCOUNT_TOKEN/password"
export BRRR_API_KEY="op://Personal/Dotfiles BRRR_API_KEY/password"
