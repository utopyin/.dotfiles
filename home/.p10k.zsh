...
# Generated by Powerlevel10k configuration wizard on 2025-05-19 at 17:52 CEST.
...
function _dotfiles_p10k_config() {
  ...
  is-at-least 5.1 "$ZSH_VERSION" || return

  # The list of segments shown on the left. Fill it with the most important segments.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    os_icon                 # os identifier
    # dir                     # current directory with custom path
  ...
  function prompt_dirr() {
    if [[ "$PWD" == "$HOME/Documents/Void/Dev" ]]; then
      p10k segment -f 208 -i '👨‍💻' -t 'Dev'
    else
      prompt_dir
    fi
...
_dotfiles_p10k_config
unset -f _dotfiles_p10k_config
