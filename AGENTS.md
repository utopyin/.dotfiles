...
2. Runtime/config selects an implementation layer (`PackageInstaller.Homebrew`, `PackageInstaller.Omarchy`, `PackageInstaller.Apt`, etc.).
...
- `home/macos/`, `home/omarchy/`, and `home/ubuntu/` — environment-specific home overlays.
