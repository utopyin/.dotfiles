...
| `pi-mcp`                 | Davis    | `e5a5beb9029f207a82fe4d50b024ad7696fb7ae0` | `home/.pi/agent/extensions/pi-mcp/`                   | Vendored instead of npm `pi-mcp-adapter`; stale installer files were removed and dependencies are pinned by its extension-local lockfile. |
